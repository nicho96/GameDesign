	...
	private class Screen extends JPanel implements Runnable {
		...
		public void updateScreen(Graphics g){
			...
			if(ClientStart.MAIN_GUI_SHOWN){
				...
				drawGUISprite(FRAME_WIDTH - (SpriteSheet.SPRITE_SLOT_NUM.width/2 - countMissiles.width/2) - 10, SpriteSheet.SPRITE_SLOT_NUM.height - countMissiles.height - 4, countMissiles);
