...
public class EntityCargoShip extends EntityPlayer{
	...
	private static final Sprite[] sprites_DEAD = {SpriteSheet.SPRITE_CARGO_1_DEAD, SpriteSheet.SPRITE_CARGO_2_DEAD, SpriteSheet.SPRITE_CARGO_3_DEAD, SpriteSheet.SPRITE_CARGO_4_DEAD, SpriteSheet.SPRITE_CARGO_5_DEAD};
	
	public EntityCargoShip(float x, float y, int ID){
		super(x, y, 350, sprites_ALIVE, ID);
		this.capacity = 5;
		this.speedFactor = 1;
